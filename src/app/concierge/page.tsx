      ...
      <main className="flex-1">
        <section className="px-2 md:px-5 py-20 md:py-32 max-w-[1400px] mx-auto">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-100 overflow-hidden border border-zinc-100"
          >
            {services.map((s, i) => (
              <motion.div 
                key={i} 
                variants={fadeInUp}
                className="bg-white p-12 md:p-20 hover:bg-zinc-50 transition-colors group"
              >
        ...
        <section className="px-2 md:px-5 py-24 md:py-40 border-t border-zinc-100">
          <div className="max-w-[1400px] mx-auto flex flex-col items-center">
            <motion.div 
              ...
              className="relative w-full aspect-[16/9] md:h-[600px] bg-brand-grey overflow-hidden mb-16 md:mb-20"
            >
              <Image 
            ...
            <motion.h2 
              {...fadeInUp}
              className="text-4xl md:text-6xl font-heading font-bold uppercase tracking-tighter text-center max-w-3xl leading-[0.9]"
            >
